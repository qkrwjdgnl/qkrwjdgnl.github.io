...
## 3.1 Forward Process & Reverse Process

- **Forward Process**: 이미지 $\epsilon_\theta (x_t, t)$ 가 완전한 Gaussian Noise $(x_T)$ 가 될 때까지 Gaussian Noise를 점직적으로 추가하는 Markov Process
- **Reverse Process**: Gaussian Noise $(X_T)$ 
